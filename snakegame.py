...
TILE_SIZE = 50
START = 350
HEAD_IMAGE = pygame.transform.rotate(pygame.transform.scale(pygame.image.load("greenhead.png"), (TILE_SIZE, TILE_SIZE)), -90)
BODY_IMAGE = pygame.transform.scale(pygame.image.load("greenblock.png"), (TILE_SIZE, TILE_SIZE))
APPLE_IMAGE = pygame.transform.scale(pygame.image.load("redblock.png"), (TILE_SIZE, TILE_SIZE))
